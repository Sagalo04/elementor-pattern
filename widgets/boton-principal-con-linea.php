 ...
 * @since 1.0.0
 */
class Boton_Principal_Con_Linea extends Widget_Base {
	...
	public function get_name() {
		return 'Boton-Principal-Con-Linea';
	}
	...
	public function get_title() {
		return __( 'Botón Principal Con Línea', 'Boton-Principal-Con-Linea' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'general_section',
			[
				'label' => __( 'Contenido', 'Boton-Principal-Con-Linea' ),
			]
		);
		...
		$this->add_control(
			'title',
			[
				'label' => __( 'Titulo', 'Boton-Principal-Con-Linea' ),
        ...
        $this->add_control(
			'url',
			[
				'label' => __( 'Enlace del boton', 'Boton-Principal-Con-Linea' ),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __( 'https://www.misite.com', 'Boton-Principal-Con-Linea' ),                
			]
        );
		...
		$this->start_controls_section(
			'style_section',
			[
				'label' => __( 'Style', 'Boton-Principal-Con-Linea' ),
		...
		$this->add_control(
			'text_color',
			[
				'label' => __( 'Color de texto', 'Boton-Principal-Con-Linea' ),
		...
		$this->add_control(
			'more_options_text',
			[
				'label' => __( 'Colores', 'Boton-Principal-Con-Linea' ),
		...
		$this->add_control(
			'color_title',
			[
				'label' => __( 'Colores Principales', 'Boton-Principal-Con-Linea' ),
	...
	protected function render() {
        ...
        echo '<div class="primary-btn-wrap">';
